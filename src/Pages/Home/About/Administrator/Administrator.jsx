        ...
        <div className="flex-container  gap-24 study-num max-w-[1300px] m-auto">
          <div className="lg:col-span-2 md:col-span-2">
            ...
            <p className="text-[21px] text-justify pt-5 pb-2">
              Smart’s administration is responsible for the strategic vision for
              the University.
            </p>
            <div className=" pb-7">
            ...
            <div className="flex">
              <div>
                <img
                  className="w-64 h-48"
                  src="https://i.ibb.co/6BbMrCf/img1.jpg"
                  alt=""
                />
              </div>
              <div>
                <p className="ft-text mx-3 text-[#991b1b] text-[12px] ">
                  PRESIDENT
                </p>
                <p className="mx-3 pt-3 pb-5 text-3xl">Christopher Kane</p>
                <p className="mx-3 ft-text text-[14px]">
                  Christopher Kane is the 23rd president of Smart University,
                  and the Chris Argyris Professor of Politology. His
                  presidential term began in July 2013.
                </p>
            ...
            <div className="flex pt-12 pb-24">
              <div>
                <img
                  className="w-64 h-48"
                  src="https://i.ibb.co/NZ7sqLY/administrator-2-160x190.jpg"
                  alt=""
                />
              </div>
              <div>
